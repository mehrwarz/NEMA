...
export const lectures = pgTable("lectures", {
    ...
    trainingId: integer("training_id").references(() => trainings.id, { onDelete: "cascade" }),
...
export const userProgress = pgTable(
    ...
    (table) => ({
        // Composite index ensures fast lookups when querying by both userId and trainingId
        userTrainingIdx: index("user_training_idx").on(table.userId, table.trainingId),
    })
);
...
export const comments = pgTable("comments", {
    id: serial("id").primaryKey(),
    userId: integer("user_id").notNull().references(() => users.id, { onDelete: "cascade" }),
    resourceId: integer("resource_id").notNull().references(() => lectures.id, { onDelete: "cascade" }),
